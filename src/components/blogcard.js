...
function Blogcard({ img, heading,message ,uppertext1,date}) {
    ...
    return (
      ...
      >
        ...
        <p style={{color:'#062A4D' ,fontSize:'18px' , fontFamily:'Poppins' , fontWeight:'600'}} className="popcardheading">{heading}</p>
        <p style={{color:'#6F7172' ,fontFamily:'Rubik',fontWeight:'400',fontSize:'13px'}}>{message}</p>
