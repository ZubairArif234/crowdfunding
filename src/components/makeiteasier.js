...
function Makeiteasier() {
    return (
        <div className="makemaindiv" style={{marginBottom:'80px'}}>
            ...
            <div className='investmentbtndiv'><button className='investmentbtn' style={{ color: 'white', backgroundColor: '#1B70F0', border: 'none' }}> <img src={play}width={10} style={{marginRight:'10px'}} /> how work</button></div>
